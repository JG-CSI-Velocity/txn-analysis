# M5F-4: PERSONAL SPEND INCREASES VISUALIZATION
print("\n" + "="*120)
print("💰 PERSONAL SPEND INCREASES - VISUALIZATION")
print("="*120)
...
bars = ax.barh(range(len(merchants)), spend_changes, color='#16a085', alpha=0.8, edgecolor='black', linewidth=0.5)
...
ax.set_title('Personal Accounts - Top 50 Spend Increases', fontsize=13, fontweight='bold', pad=15)
