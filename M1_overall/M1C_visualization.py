# ===========================================================================
# M1C VISUALIZATION - Top 25 Merchants by Unique Accounts
# ===========================================================================

fig, ax = plt.subplots(figsize=(12, 10))

# Get top 25 and reverse order so #1 is at top
top_25 = top_by_accounts.head(25).iloc[::-1]
...
ax.set_xlabel('Unique Account Count', fontsize=12, fontweight='bold')
ax.set_title('Top 25 Merchants by Unique Account Count', fontsize=14, fontweight='bold', pad=20)
